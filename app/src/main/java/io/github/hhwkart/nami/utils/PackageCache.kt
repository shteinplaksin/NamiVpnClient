...
import io.github.hhwkart.nami.ktx.listenForPackageChanges
...
object PackageCache {
    ...
    fun reload() {
        ...
        installedPackages = rawPackageInfo.filter {
            when (it.packageName) {
                "android" -> true
                else -> it.requestedPermissions == null || it.requestedPermissions?.contains(Manifest.permission.INTERNET) == true
            }
