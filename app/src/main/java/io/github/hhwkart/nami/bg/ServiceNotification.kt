...
import io.github.hhwkart.nami.ui.SwitchActivity
import io.github.hhwkart.nami.utils.Theme
...
class ServiceNotification(
    ...
    init {
        val serviceContext = service as Context
        NotificationChannels.ensure(serviceContext)

        Theme.apply(app)
        Theme.apply(service)
        builder.color = service.getColorAttr(R.attr.colorPrimary)

        serviceContext.registerReceiver(this, IntentFilter().apply {
