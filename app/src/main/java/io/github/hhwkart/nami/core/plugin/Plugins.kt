package io.github.hhwkart.nami.core.plugin
...
object Plugins {
    const val AUTHORITIES_PREFIX_SEKAI_EXE = "io.github.hhwkart.nami.plugin."
    const val AUTHORITIES_PREFIX_NEKO_EXE = "moe.matsuri.exe."

    const val ACTION_NATIVE_PLUGIN = "io.github.hhwkart.nami.plugin.ACTION_NATIVE_PLUGIN"

    const val METADATA_KEY_ID = "io.github.hhwkart.nami.plugin.id"
    const val METADATA_KEY_EXECUTABLE_PATH = "io.github.hhwkart.nami.plugin.executable_path"
    ...
    private fun getExtPluginOld(pluginId: String): List<ProviderInfo> {
        ...
        val list1 = SagerNet.application.packageManager.queryIntentContentProviders(
            Intent(ACTION_NATIVE_PLUGIN, buildUri(pluginId, "io.github.hhwkart.nami")), flags
        )
