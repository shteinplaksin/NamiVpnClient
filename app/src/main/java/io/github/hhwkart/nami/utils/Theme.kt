...
object Theme {
    ...
    fun getTheme(): Int {
        return getTheme(selectedLegacyTheme())
    }

    fun getDialogTheme(): Int {
        return getDialogTheme(selectedLegacyTheme())
    }

    /** Keep legacy windows aligned with the active Compose theme mode. */
    private fun selectedLegacyTheme(): Int = if (
    ...
    fun getNightMode(): Int = getNightMode(DataStore.nightTheme)
