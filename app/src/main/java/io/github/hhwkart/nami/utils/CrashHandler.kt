...
import io.github.hhwkart.nami.ui.BlankActivity
...
object CrashHandler : Thread.UncaughtExceptionHandler {
    ...
    fun buildReportHeader(): String {
        var report = ""
        report += "Nami for Android ${SagerNet.appVersionNameForDisplay} (${BuildConfig.VERSION_CODE})\n"
